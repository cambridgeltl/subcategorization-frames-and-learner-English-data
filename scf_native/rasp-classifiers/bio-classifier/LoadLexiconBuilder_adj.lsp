...
(defparameter *rule-file-name* "rule-adjs")
;;(defparameter *rule-file-name* "rule-verbs-lexicon")
(defparameter *backoff1* "rule-adjs")
(defparameter *backoff2* "rule-adjs")
(defparameter *backoff3* "rule-adjs")
