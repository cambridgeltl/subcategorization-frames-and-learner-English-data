...
(defparameter *rule-file-name* "rule-nouns")
;;(defparameter *rule-file-name* "rule-verbs-lexicon")
(defparameter *backoff1* "rule-nouns")
(defparameter *backoff2* "rule-nouns")
(defparameter *backoff3* "rule-nouns")
